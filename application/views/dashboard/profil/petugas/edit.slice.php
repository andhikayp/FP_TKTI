            ...
            <div class="form-group row">
                <div class="col-6">
                    <div class="form-material form-material-primary input-group">
                        <input required="" value="-7.424586942420247" type="text" class="form-control" id="latitude" name="sd_latitude_siswa">
                        <label for="sd_uasbn">Latitude</label>
                    </div>
                </div>
                <div class="col-5">
                    <div class="form-material form-material-primary input-group">
                        <input required="" value="112.55414313428707" type="text" class="form-control" id="longitude" name="sd_longitude_siswa">
